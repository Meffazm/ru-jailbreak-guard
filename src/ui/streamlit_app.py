...
# Streamlit re-executes module-level code on every interaction; the second
# Counter() registration would raise on the global CollectorRegistry.
_COUNTER_NAME = "ru_jailbreak_disagreement_total"
try:
    ...
    _DISAGREEMENT = cast(Counter, REGISTRY._names_to_collectors[_COUNTER_NAME])
...
def _view_comparison(text: str) -> None:
    ...
    if labels and len(set(labels)) == 1:
        ...
        # Emit disagreement metric for drift correlation.
